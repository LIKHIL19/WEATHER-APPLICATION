...
data = requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city_name+"&appid=16bda0c12b52656d1eb2f703aa3f22d8").json()
print(data)
# root = tk.Tk()
...
# com = ttk.Combobox(search_frame, font=("Helvetica", 16), width=20, values=list_names)
